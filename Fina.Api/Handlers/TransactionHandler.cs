...
namespace Fina.Api.Handlers
{
    public class TransactionHandler(AppDbContext context) : ITransactionHandler
    {
        ...
        public async Task<Response<Transaction?>> GetByIdAsync(GetTransactionByIdRequest request)
        {
            try
            {
                ...
                return transaction is null
                    ? new Response<Transaction?>(null, 404, message: "Categoria não encontrada")
                    : new Response<Transaction?>(transaction);
            }
            catch
            {
                return new Response<Transaction?>(null, 500, message: "Não foi possível recuperar a transação");
            }
        }
        ...
        public async Task<Response<Transaction?>> CreateAsync(CreateTransactionRequest request)
        {
            ...
            {
                return new Response<Transaction?>(null, 500, message: "Não foi possível criar sua transação");
            }
        }
        ...
        public async Task<Response<Transaction?>> UpdateAsync(UpdateTransactionRequest request)
        {
            ...
            {
                return new Response<Transaction?>(null, 500, message: "Não foi possível atualizar sua transação");
            }
        }
        ...
        public async Task<Response<Transaction?>> DeleteAsync(DeleteTransactionRequest request)
        {
            ...
            {
                return new Response<Transaction?>(null, 500, message: "Não foi possível excluir sua transação");
            }
        }
    }
}
